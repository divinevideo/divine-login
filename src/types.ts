// ABOUTME: Type definitions for Divine login client library
 ...
 */
export interface DivineStorage {
  getItem(key: string): string | null;
  setItem(key: string, value: string): void;
  removeItem(key: string): void;
}

/** @deprecated Use DivineStorage instead */
export type KeycastStorage = DivineStorage;
...
/**
 * Divine login client configuration
 */
export interface DivineClientConfig {
  /** Server URL (e.g., "https://login.divine.video") */
  serverUrl: string;
  /** OAuth client ID */
  clientId: string;
  /** OAuth redirect URI */
  ...
  storage?: DivineStorage;
}

/** @deprecated Use DivineClientConfig instead */
export type KeycastClientConfig = DivineClientConfig;
